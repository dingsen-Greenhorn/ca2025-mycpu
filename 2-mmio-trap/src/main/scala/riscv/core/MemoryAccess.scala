  ...
  when(io.memory_read_enable) {
    ...
    io.wb_memory_read_data := MuxLookup(io.funct3, 0.U)(
      Seq(
        ...
        Cat(Fill(16, data(15)), data(15,0)),   // lower halfword (bits 15:0)
        Cat(Fill(16, data(31)), data(31,16))   // upper halfword (bits 31:16)
        ),
        ...
        InstructionsTypeL.lhu -> Mux(
          mem_address_index === 0.U,
        Cat(Fill(16, 0.U), data(15,0)),   // lower halfword (bits 15:0)
        Cat(Fill(16, 0.U), data(31,16))   // upper halfword (bits 31:16)
        ),
